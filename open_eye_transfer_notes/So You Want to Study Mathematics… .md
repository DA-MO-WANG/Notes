...
​		我听到过很多极端无知的表述，其中有一条很多人不断重复，“世上只有两个人，一个是数学人；一个是语言人”。这里暗含一种事实：如果你理解论文的结构，如果你理解英语语言语法的结构，你就能理解宇宙语言模型。这么说并不是说这很容易——不！数学是一门极具挑战的学科，这里没有容易、直接的东西，坦白的说，但凡一种技术追求到某种优先的水平，都不会是只有容易和直接的感受。
